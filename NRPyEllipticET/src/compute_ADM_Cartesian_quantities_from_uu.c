...
#include "./set_Cparameters.h"
    ...
    if( CCTK_EQUALS(initial_lapse,"NRPyEllipticET-psi^n") ) {
        lapse_power_of_psi_initial_data(cctkGH,params,x,y,z,in_gfs,alpha);
    }
    else if( CCTK_EQUALS(initial_lapse,"NRPyEllipticET-averaged") ) {
        lapse_averaged_initial_data(    cctkGH,orbital_plane,params,x,y,z,position_shift,in_gfs,alpha);
    }
    else {
