 ...
 */
static inline void conformally_flat_BBH_radiation_bcs_curvilinear(const paramstruct *restrict params, const bc_struct *restrict bcstruct,REAL *restrict xx[3],
  ...
  for(int which_gf=0;which_gf<NUM_GFS;which_gf++) {
    for(int which_gz = 0; which_gz < NGHOSTS; which_gz++) {
      ...
      for(int pt=0;pt<bcstruct->num_ob_gz_pts[which_gz];pt++) {
        ...
        conformally_flat_BBH_radiation_bcs_curvilinear(params, bcstruct, xx, gfs, gfs_rhss,  which_gf,
