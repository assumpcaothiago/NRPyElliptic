...
void MoL_step_forward_in_time(griddata_struct *restrict griddata, const REAL dt) {
  ...
  // -={ START k1 substep }=-
  {
    ...
    //apply_bcs_curvilinear_radiation(params, bcstruct, NUM_EVOL_GFS, evol_gf_parity, griddata->xx, y_n_gfs, k_odd_gfs);
    apply_bcs_sommerfeld(params, griddata->xx, bcstruct, NUM_EVOL_GFS, evol_gf_parity, y_n_gfs, k_odd_gfs);
    LOOP_ALL_GFS_GPS(i) {
  ...
  // -={ START k2 substep }=-
  {
    ...
    //apply_bcs_curvilinear_radiation(params, bcstruct, NUM_EVOL_GFS, evol_gf_parity, griddata->xx, k_odd_gfs, k_even_gfs);
    apply_bcs_sommerfeld(params, griddata->xx, bcstruct, NUM_EVOL_GFS, evol_gf_parity, k_odd_gfs, k_even_gfs);
    LOOP_ALL_GFS_GPS(i) {
  ...
  // -={ START k3 substep }=-
  {
    ...
    //apply_bcs_curvilinear_radiation(params, bcstruct, NUM_EVOL_GFS, evol_gf_parity, griddata->xx, k_even_gfs, k_odd_gfs);
    apply_bcs_sommerfeld(params, griddata->xx, bcstruct, NUM_EVOL_GFS, evol_gf_parity, k_even_gfs, k_odd_gfs);
    LOOP_ALL_GFS_GPS(i) {
      const REAL k_odd_gfsL = k_odd_gfs[i];
      const REAL y_nplus1_running_total_gfsL = y_nplus1_running_total_gfs[i];
      const REAL y_n_gfsL = y_n_gfs[i];
